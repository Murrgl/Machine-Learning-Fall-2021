    ...
    async def pub_sub_function(self, apply_function):  # async
        ...
        try:
            ...
            while True:
                ...
                if timestamp:
                    ...
                    if 'confidence' not in data or data['confidence'] >= 0.7:
                        ...
                        if 'smooth' not in data or data['smooth']:
                            ...
                            logging.debug("TIME: smooth class init: {}".format((findCurrentTime() - time_now) / 1000000))
                            time_now = findCurrentTime()
                            ...
                            if "au_r" in data and data['au_r']:
                                ...
                                logging.debug("TIME: Smooth AU: {}".format((findCurrentTime() - time_now) / 1000000))
                                time_now = findCurrentTime()
                            ...
                            if "pose" in data and data['pose']:
                                ...
                                logging.debug("TIME: Smooth head pose: {}".format((findCurrentTime() - time_now) / 1000000))
                                # time_now = time.time()
                ...
                logging.debug("TIME: Total bridge: {}".format((findCurrentTime() - time_now) / 1000000))
